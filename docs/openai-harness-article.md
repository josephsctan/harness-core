...
**By Ryan Lopopolo, Member of the Technical Staff — OpenAI**
...
### Architectural layers per business domain

Within each business domain (e.g. App Settings), code can only depend "forward" through a fixed set of layers:
